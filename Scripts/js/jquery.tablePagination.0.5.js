 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
      ...
      function createPaginationElements() {
        var htmlBuffer = [];
        htmlBuffer.push("<div id='tablePagination' class='open'>");
        ...
        htmlBuffer.push("<img id='tablePagination_firstPage' src='"+defaults.firstArrow+"'><span id='tablePagination_firstspan'>First</span>");
        htmlBuffer.push("<img id='tablePagination_prevPage' src='"+defaults.prevArrow+"'><span id='tablePagination_prevspan'>Previous&nbsp;&nbsp;</span>");
        htmlBuffer.push("<font color='white'>Pg&nbsp;&nbsp;</font>");
        htmlBuffer.push("<select id='tablePagination_currPage'><option value='"+currPageNumber+"'>"+currPageNumber+"</option></select>");
        htmlBuffer.push("<font color='white'>&nbsp;&nbsp;of</font><span id='tablePagination_totalPages'>"+totalPages+"</span>");
        htmlBuffer.push("<span id='tablePagination_nextspan'>Next</span><img id='tablePagination_nextPage' src='"+defaults.nextArrow+"'>");
        htmlBuffer.push("<span id='tablePagination_lastspan'>Last</span><img id='tablePagination_lastPage' src='" + defaults.lastArrow + "'>");
        htmlBuffer.push("<button type='button' id='btnclick'>Save</button>");
        htmlBuffer.push("</span>");
        htmlBuffer.push("</div>");
       ...
       /* var totpages=totalPages;
        ...
        for (var i = curpage; i <= totpages; i++) {
